...
# Optimal MSwitch Configuration
# This test uses the optimal UDP and filter settings for minimal buffering

echo "=== Optimal MSwitch Configuration ==="
echo "This test uses the optimal settings for minimal buffering"
...
echo "UDP: fifo_size=1 (minimal buffering with overrun handling)"
echo "Filter: tube=2 (2 frames per input during startup)"
echo "Expected: ~0.5-1 second total buffer"
